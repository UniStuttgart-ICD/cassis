...
"""
Cassis Test Suite
Interactive testing tool for Cassis tools and workflows

This module provides a comprehensive testing interface for Cassis tools,
...
def show_help():
    ...
    help_panel = Panel(
        ...
        box=box.ROUNDED,
        border_style="blue",
        title="[bold]Cassis Test Suite Help[/bold]"
    )
...
def run_comprehensive_test():
    ...
    console.print("\n🧪 [bold blue]Running Comprehensive Cassis Test Suite[/bold blue]")
    console.print("=" * 80)
...
def show_main_menu():
    ...
    header_panel = Panel(
        "[bold blue]🚀 Cassis Test Suite[/bold blue]\n"
...
def create_cli_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Cassis Test Suite - Command Line Interface",
        ...
        while True:
            ...
            try:
                if choice == "1":
                    ...
                    console.print("\n👋 [green]Thank you for using Cassis Test Suite![/green]")
                    break
