...
- Agent-side MCP setup guide with copy-ready instructions for supported clients
- Setup reminder and setup actions on the Cassis Grasshopper component
- Setup documentation bundled in Windows and macOS Yak packages

### Changed

- Rhino Package Manager metadata now links directly to the agent setup guide
- The setup skill skips plugin installation when Cassis is already installed

## [1.3.3] - 2026-07-28

### Added

- Native macOS Yak distribution targeting `net8.0`
- Platform-specific CI builds and release validation for Windows and macOS

### Changed

- The Windows Yak distribution now contains only the `net8.0-windows` build
